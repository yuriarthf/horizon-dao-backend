...
export type UserShare_orderBy = "id" | "address" | "committedFunds" | "amount" | "share" | "claimed" | "iro";
...
export type IROResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes["IRO"] = ResolversParentTypes["IRO"],
> = ResolversObject<{
  ...
  shares?: Resolver<
    Maybe<Array<ResolversTypes["UserShare"]>>,
    ParentType,
    ContextType,
    RequireFields<IROsharesArgs, "skip" | "first">
  >;
...
export type IROSetResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes["IROSet"] = ResolversParentTypes["IROSet"],
> = ResolversObject<{
  id?: Resolver<ResolversTypes["Bytes"], ParentType, ContextType>;
...
> = ResolversObject<{
  iroset?: Resolver<
    Maybe<ResolversTypes["IROSet"]>,
    ParentType,
    ContextType,
    RequireFields<QueryirosetArgs, "id" | "subgraphError">
  >;
  irosets?: Resolver<
    Array<ResolversTypes["IROSet"]>,
    ParentType,
    ContextType,
    RequireFields<QueryirosetsArgs, "skip" | "first" | "subgraphError">
  >;
  userShare?: Resolver<
    Maybe<ResolversTypes["UserShare"]>,
    ParentType,
    ContextType,
    RequireFields<QueryuserShareArgs, "id" | "subgraphError">
  >;
  userShares?: Resolver<
    Array<ResolversTypes["UserShare"]>,
    ParentType,
    ContextType,
    RequireFields<QueryuserSharesArgs, "skip" | "first" | "subgraphError">
  >;
  iro?: Resolver<
    Maybe<ResolversTypes["IRO"]>,
    ParentType,
    ContextType,
    RequireFields<QueryiroArgs, "id" | "subgraphError">
  >;
  iros?: Resolver<
    Array<ResolversTypes["IRO"]>,
    ParentType,
    ContextType,
    RequireFields<QueryirosArgs, "skip" | "first" | "subgraphError">
  >;
...
> = ResolversObject<{
  iroset?: SubscriptionResolver<
    Maybe<ResolversTypes["IROSet"]>,
    "iroset",
    ParentType,
    ContextType,
    RequireFields<SubscriptionirosetArgs, "id" | "subgraphError">
  >;
  irosets?: SubscriptionResolver<
    Array<ResolversTypes["IROSet"]>,
    "irosets",
    ParentType,
    ContextType,
    RequireFields<SubscriptionirosetsArgs, "skip" | "first" | "subgraphError">
  >;
  userShare?: SubscriptionResolver<
    Maybe<ResolversTypes["UserShare"]>,
    "userShare",
    ParentType,
    ContextType,
    RequireFields<SubscriptionuserShareArgs, "id" | "subgraphError">
  >;
  userShares?: SubscriptionResolver<
    Array<ResolversTypes["UserShare"]>,
    "userShares",
    ParentType,
    ContextType,
    RequireFields<SubscriptionuserSharesArgs, "skip" | "first" | "subgraphError">
  >;
  iro?: SubscriptionResolver<
    Maybe<ResolversTypes["IRO"]>,
    "iro",
    ParentType,
    ContextType,
    RequireFields<SubscriptioniroArgs, "id" | "subgraphError">
  >;
  iros?: SubscriptionResolver<
    Array<ResolversTypes["IRO"]>,
    "iros",
    ParentType,
    ContextType,
    RequireFields<SubscriptionirosArgs, "skip" | "first" | "subgraphError">
  >;
...
export type UserShareResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes["UserShare"] = ResolversParentTypes["UserShare"],
> = ResolversObject<{
  id?: Resolver<ResolversTypes["Bytes"], ParentType, ContextType>;
...
export async function getMeshOptions(): Promise<GetMeshOptions> {
  ...
  const horizonIroHandler = new GraphqlHandler({
    name: "horizon-iro",
    config: { endpoint: "https://api.studio.thegraph.com/query/39814/horizon-iro-test/v0.0.15" },
    baseDir,
    cache,
    pubsub,
...
export type getUserSharesQuery = {
  userShares: Array<
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    ...
    getIros(variables?: getIrosQueryVariables, options?: C): Promise<getIrosQuery> {
      return requester<getIrosQuery, getIrosQueryVariables>(
        getIrosDocument,
        variables,
        options,
      ) as Promise<getIrosQuery>;
    },
    getUserShares(variables: getUserSharesQueryVariables, options?: C): Promise<getUserSharesQuery> {
      return requester<getUserSharesQuery, getUserSharesQueryVariables>(
        getUserSharesDocument,
        variables,
        options,
      ) as Promise<getUserSharesQuery>;
    },
  };
}
