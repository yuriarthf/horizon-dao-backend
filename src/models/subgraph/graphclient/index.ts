...
> = ResolversObject<{
  ...
  commitedFunds?: Resolver<ResolversTypes["BigInt"], ParentType, ContextType>;
...
export async function getMeshOptions(): Promise<GetMeshOptions> {
  ...
  const horizonIroHandler = new GraphqlHandler({
    name: "horizon-iro",
    config: { endpoint: "https://api.studio.thegraph.com/query/39814/horizon-iro-test/v0.0.14" },
    baseDir,
    cache,
    pubsub,
...
export type getIroQuery = {
  iros: Array<
    Pick<
      ...
      | "listingOwner"
      | "listingOwnerShare"
    > & { shares?: Maybe<Array<Pick<UserShare, "address" | "commitedFunds" | "amount" | "share" | "claimed">>> }
  >;
};
